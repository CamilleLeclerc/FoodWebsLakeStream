...
n_beta  = ncol(X_obs)
colnames(X_obs) = colnames(X_obs) = c("Intercept","Habitat","Temperature","Temperature^2","Temperature * Habitat","BOD","BOD^2","Habitat * BOD","Temperature * BOD","Temperature * BOD * Habitat","Species Richness","Year")
