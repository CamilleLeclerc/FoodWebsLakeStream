...
X_obs   = cbind(1,year,temp,temp^2,type,type*temp,dbo,dbo^2,type*dbo,alt,rich)
X_mis   = cbind(1,year,temp,temp^2,type,type*temp,  1,    1,type*1  ,alt,rich)
n_beta  = ncol(X_obs)
...
colnames(chain_) = c("P","1","year","temp","temp^2","type","type*temp","dbo","dbo^2","type*dbo","alt","rich")
