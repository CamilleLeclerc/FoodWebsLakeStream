...
```{r load}
myload(fish_diet_shift, ind_size, dir = mypath("data"))
```
...
`r nb_ind_not_in_diet/nrow(ind_size) %>% round(., 2)`. However, more than half of the
missing individuals are represented by "Coregonus lavaretus".
...
```{r prep data}
myload(pred_win, fish_diet_shift, resource_diet_shift,
  dir = mypath("data"))
