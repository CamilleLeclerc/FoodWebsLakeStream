...
yearly_avg_dbo5_lake <- read.csv("../data/raw-data/environment/yearly_avg_dbo5_lake.csv")
yearly_avg_temp_lake <- read.csv("../data/raw-data/environment/yearly_avg_temp_lake.csv")
...
op_analysis <- read.csv("../data/raw-data/op_analysis.csv")
station_analysis <- read.csv("../data/raw-data/station_analysis.csv", sep=";")
yearly_avg_water_chemical_stream <- read.csv("../data/raw-data/environment/yearly_avg_water_chemical_stream.csv")
yearly_avg_water_temperature_stream <- read.csv("../data/raw-data/environment/yearly_avg_water_temperature_stream.csv")
...
metric_stream <- network_stream_metrics %>% dplyr::select(connectance, richness, nbnode, w_trph_lvl_avg, max_troph_lvl)
  ...
  colnames(stream_spatial_coordinates)[2] <- "station.name"
  stream_spatial_coordinates$station <- as.numeric(stream_spatial_coordinates$station)
